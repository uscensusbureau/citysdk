(function (global, factory) {
	...
	(global.CensusRequestValidator = factory(global.$,global.Terraformer,global.Terraformer.ArcGIS));
	...
	var zcta = { "urls": { "test": "http://localhost:8000/dist/resources/zipcode-to-coordinates.json", "prod": "" }, "use": "http://localhost:8000/dist/resources/zipcode-to-coordinates.json" };
	var config = {
		zcta: zcta
	};
	    ...
	    value: function getLatLng(request) {
	      ...
	      if (request.address) {
	        CensusRequestUtils.getLatLngFromAddress(request.address).then(function (response) {
	          var coordinates = response.addressMatches[0].coordinates;
	        ...
	        CensusRequestUtils.getLatLngFromZipcode(request.zip).then(function (response) {
	          var coordinates = response.features[0].attributes;
...
//# sourceMappingURL=census-request-validator.js.map