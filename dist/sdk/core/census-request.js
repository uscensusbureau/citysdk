(function (global, factory) {
	...
	(global.CensusRequest = factory(global.$,global.Terraformer,global.Terraformer.ArcGIS));
	...
	CitySdk.stateCapitalCoordinates = stateCapitalsLatLng;
	...
	var CensusGeoRequest = function () {
	  ...
	  createClass(CensusGeoRequest, null, [{
	    ...
	    value: function supplementalRequest(req, res, featureIndex) {
	      ...
	      CensusSummaryRequest.request(suppRequest).then(function (response) {
	      ...
	      if (request.data) {
	        (function () {
	          ...
	          if (supplementalRequests.length) {
	            $.when.apply($, supplementalRequests).done(function () {
	              onRequestSuccess(response);
	            }, onRequestError);
	          }
	        })();
