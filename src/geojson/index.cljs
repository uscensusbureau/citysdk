...
; TODO: Base URL changes in 2000: https://tigerweb.geo.census.gov/arcgis/rest/services/Census2010/tigerWMS_Census2000/MapServer
...
(def geoKeyMap                                                             ; :id<-json Examples:
  {:us                                                                     ; TODO: Changed from `:nation`
   ...
   :region
   {
    ...
    :2000 {:lev<-file "rg"       :scopes {:us [           "500k"] :st nil      } :wms {:layers ["60"] :lookup :2010}      :id<-json [:REGION]}}       ; "4"
   :division
   {
    ...
    :2000 {:lev<-file "dv"       :scopes {:us [           "500k"] :st nil      } :wms {:layers ["58"] :lookup :2010}      :id<-json [:DIVISION]}}     ; "3"
   :state
   {
    ...
    :2000 {:lev<-file "st"       :scopes {:us [           "500k"] :st ["500k"] } :wms {:layers ["70"] :lookup :2010}      :id<-json [:STATE]}         ; "01"
   ...
   :county
   {
    ...
    :2000 {:lev<-file "co"       :scopes {:us [           "500k"] :st ["500k"] } :wms {:layers ["72" ] :lookup :2010}     :id<-json [:STATE :COUNTY]} ; "01", "077"
   ...
   :county-subdivision
   {
    ...
    :2000 {:lev<-file "cs"       :scopes {:us nil                 :st ["500k"] } :wms {:layers ["18"]  :lookup :2010}     :id<-json [:STATE :COUNTY :COUSUBFP]} ; "44","007","80780"
   ...
   :tract
   {
    ...
    :2000 {:lev<-file "tr"       :scopes {:us nil                 :st ["500k"] } :wms {:layers ["6" ] :lookup :2010}      :id<-json [:STATE :COUNTY :TRACT]} ; "44","007","011402"
   ...
   :block-group
   {
    ...
    :2000 {:lev<-file "bg"       :scopes {:us nil                 :st ["500k"] } :wms {:layers ["8" ] :lookup :2010}      :id<-json [:STATE :COUNTY :TRACT :BLKGROUP]} ; "44","007","011402","8"
   ...
   :place
   {
    ...
    :2000 {:lev<-file "pl"       :scopes {:us nil                 :st ["500k"] } :wms {:layers ["24" "26"] :lookup :2010} :id<-json [:STATE :PLACEFP]} ; "44","80780"
   ...
   :alaska-native-regional-corporation
   {
    ...
    :2000 {:lev<-file "an"       :scopes {:us nil                 :st ["500k"] } :wms {:layers ["28"] :lookup :2010}      :id<-json [:STATE :ANRCFP]} ; "02","03950"
   ...
   :american-indian-area!alaska-native-area!hawaiian-home-land
   {
    ...
    :2000 {:lev<-file "na"       :scopes {:us [           "500k"] :st nil      } :wms {:layers ["48"] :lookup :2010}      :id<-json [:AIANACE]}       ; "6165"
   ...
   :urban-area
   {
    :2017 {:lev<-file "ua"       :scopes {:us [           "500k"] :st nil      } :wms {:layers ["62"] :lookup :2000}      :id<-json [:GEOID10]}       ; "58600"
    :2016 {:lev<-file "ua"       :scopes {:us [           "500k"] :st nil      } :wms {:layers ["62"] :lookup :2000}      :id<-json [:GEOID10]}       ; "58600"
    :2015 {:lev<-file "ua"       :scopes {:us [           "500k"] :st nil      } :wms {:layers ["62"] :lookup :2000}      :id<-json [:GEOID10]}       ; "58600"
    :2014 {:lev<-file "ua"       :scopes {:us [           "500k"] :st nil      } :wms {:layers ["62"] :lookup :2000}      :id<-json [:GEOID10]}       ; "58600"
    :2013 {:lev<-file "ua"       :scopes {:us [           "500k"] :st nil      } :wms {:layers ["62"] :lookup :2000}      :id<-json [:GEOID10]}       ; "71155"
    :2012 {:lev<-file "uac"      :scopes {:us [           "500k"] :st nil      } :wms nil                                 :id<-json [:UACE10]}        ; "79282"
    :2000 {:lev<-file "ua"       :scopes {:us [           "500k"] :st nil      } :wms {:layers ["62"] :lookup :2000}      :id<-json [:UA]}            ; "45748"
   ...
   :congressional-district
   {
    ...
    :2010 {:lev<-file "500"      :scopes {:us ["5m" "20m"       ] :st ["500k"] } :wms {:layers ["62"] :lookup [:STATE :CD111]} :id<-json [:STATE :CD]} ; "44","01"
   ...
   :state-legislative-district-_upper-chamber_
   {
    ...
    :2000 {:lev<-file "su"       :scopes {:us nil                 :st ["500k"] } :wms {:layers ["52"] :lookup :2010}      :id<-json [:STATE :SLDU]}}  ; "44","033"
   :state-legislative-district-_lower-chamber_
   {
    ...
    :2000 {:lev<-file "sl"       :scopes {:us nil                 :st ["500k"] } :wms {:layers ["54"] :lookup :2010}      :id<-json [:STATE :SLDL]}}  ; "44","063"
   :zip-code-tabulation-area
   {
    ...
    :2010 {:lev<-file "860"      :scopes nil                                     :wms {:layers ["8"] :lookup :2010}       :id<-json [:ZCTA5]}         ; BFJO :(
    :2000 {:lev<-file "zt"       :scopes {:us [           "500k"] :st ["500k"] } :wms {:layers ["4"] :lookup :2010}       :id<-json [:ZCTA]}}         ; "99782"
   :school-district-_elementary_
   {
    ...
    :2000 {:lev<-file "se"       :scopes {:us nil                 :st ["500k"] } :wms {:layers ["16"] :lookup :2010}      :id<-json [:STATE :SD_E]}}  ; "44","00360"
   ...
   :school-district-_unified_
   {
    ...
    :2000 {:lev<-file "sn"       :scopes {:us nil                 :st ["500k"] } :wms {:layers ["12"] :lookup :2010}      :id<-json [:STATE :SD_U]}}  ; "44","00270"
