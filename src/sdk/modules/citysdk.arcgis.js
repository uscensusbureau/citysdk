 ...
 *      "services":  <required> This is the name of the API
 * }
 *
...
arcgisModule.prototype.getLevelDictionary = function(request, callback) {
  ...
  var arcURL = arcURL + "arcgis/rest/services/{services}/FeatureServer/?f=pjson";
...
arcgisModule.prototype.getVariableDictionary = function(request, callback) {
  ...
  var arcURL = arcURL + "arcgis/rest/services/{services}/FeatureServer/{level}?f=pjson";
  arcURL = arcURL.replace(apiPattern, api);
