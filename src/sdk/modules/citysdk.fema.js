...
FEMAModule.prototype.DEFAULT_ENDPOINTS.apiURL = "https://www.fema.gov/services/open/v1/DisasterDeclarationsSummaries?";
 ...
 *          "url": "/services/open/v1/DisasterDeclarationsSummaries?$filter=disasterNumber%20eq%204100"
 *      },
...
FEMAModule.prototype.APIRequest = function (request, callback) {
    ...
    CitySdk.get(disasterURL).done(function (response) {
