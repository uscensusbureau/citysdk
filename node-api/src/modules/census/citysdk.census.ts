...
const usBoundingBox = require("./json/us-bounds.json");
const availableDatasets = require("./json/available-datasets.json");
const requiredVariables = require("./json/required-variables.json");
