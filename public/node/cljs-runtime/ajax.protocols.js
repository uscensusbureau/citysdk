...
ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4205__auto__,k23221,else__4206__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k23221,else__4206__auto__);
...
ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__23220){
var self__ = this;
var G__23220__$1 = this;
return (new cljs.core.RecordIter((0),G__23220__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
var h__4061__auto____$1 = (function (){var fexpr__23226 = ((function (h__4061__auto__,this__4199__auto____$1){
return (function (coll__4200__auto__){
return (-473222333 ^ cljs.core.hash_unordered_coll(coll__4200__auto__));
});})(h__4061__auto__,this__4199__auto____$1))
;
return fexpr__23226(this__4199__auto____$1);
})();
...
ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this23222,other23223){
var self__ = this;
var this23222__$1 = this;
return ((!((other23223 == null))) && ((this23222__$1.constructor === other23223.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23222__$1.status,other23223.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23222__$1.body,other23223.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23222__$1.status_text,other23223.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23222__$1.headers,other23223.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23222__$1.was_aborted,other23223.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23222__$1.__extmap,other23223.__extmap)));
});
...
ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4210__auto__,k__4211__auto__,G__23220){
var self__ = this;
var this__4210__auto____$1 = this;
var pred__23236 = cljs.core.keyword_identical_QMARK_;
var expr__23237 = k__4211__auto__;
if(cljs.core.truth_((function (){var G__23239 = new cljs.core.Keyword(null,"status","status",-1997798413);
...
return (new ajax.protocols.Response(G__23220,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__23241 = new cljs.core.Keyword(null,"body","body",-2049205669);
var G__23242 = expr__23237;
return (pred__23236.cljs$core$IFn$_invoke$arity$2 ? pred__23236.cljs$core$IFn$_invoke$arity$2(G__23241,G__23242) : pred__23236.call(null,G__23241,G__23242));
})())){
return (new ajax.protocols.Response(self__.status,G__23220,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__23243 = new cljs.core.Keyword(null,"status-text","status-text",-1834235478);
var G__23244 = expr__23237;
return (pred__23236.cljs$core$IFn$_invoke$arity$2 ? pred__23236.cljs$core$IFn$_invoke$arity$2(G__23243,G__23244) : pred__23236.call(null,G__23243,G__23244));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,G__23220,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__23245 = new cljs.core.Keyword(null,"headers","headers",-835030129);
var G__23246 = expr__23237;
return (pred__23236.cljs$core$IFn$_invoke$arity$2 ? pred__23236.cljs$core$IFn$_invoke$arity$2(G__23245,G__23246) : pred__23236.call(null,G__23245,G__23246));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__23220,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__23247 = new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828);
var G__23248 = expr__23237;
return (pred__23236.cljs$core$IFn$_invoke$arity$2 ? pred__23236.cljs$core$IFn$_invoke$arity$2(G__23247,G__23248) : pred__23236.call(null,G__23247,G__23248));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__23220,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4211__auto__,G__23220),null));
}
}
}
}
...
ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4202__auto__,G__23220){
var self__ = this;
var this__4202__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__23220,self__.__extmap,self__.__hash));
});
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__23224){
var extmap__4236__auto__ = (function (){var G__23249 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__23224,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__23224)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__23249);
} else {
return G__23249;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__23224),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__23224),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__23224),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__23224),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__23224),null,cljs.core.not_empty(extmap__4236__auto__),null));
});
