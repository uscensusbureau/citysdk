...
test.core.stats_key = (function (){var target_obj_25879 = shadow.js.shim.module$dotenv.load();
var _STAR_runtime_state_STAR_25882 = oops.state._STAR_runtime_state_STAR_;
oops.state._STAR_runtime_state_STAR_ = oops.state.prepare_state(target_obj_25879,(new Error()),function(){arguments[0].apply(console,Array.prototype.slice.call(arguments,1))});

try{var next_obj_25880 = ((oops.core.validate_object_access_dynamically(target_obj_25879,(0),"parsed",true,true,false))?(target_obj_25879["parsed"]):null);
var next_obj_25881 = ((oops.core.validate_object_access_dynamically(next_obj_25880,(0),"Census_Key_Pro",true,true,false))?(next_obj_25880["Census_Key_Pro"]):null);
return next_obj_25881;
}finally {oops.state._STAR_runtime_state_STAR_ = _STAR_runtime_state_STAR_25882;
}})();
...
var len__4531__auto___25884 = arguments.length;
var i__4532__auto___25885 = (0);
while(true){
if((i__4532__auto___25885 < len__4531__auto___25884)){
args__4534__auto__.push((arguments[i__4532__auto___25885]));

var G__25886 = (i__4532__auto___25885 + (1));
i__4532__auto___25885 = G__25886;
continue;
} else {
}
break;
...
/** @this {Function} */
test.core.get_path.cljs$lang$applyTo = (function (seq25883){
var self__4519__auto__ = this;
return self__4519__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq25883));
});
...
var G__25890 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [com.rpl.specter.MAP_VALS], null);
return (precompiled25889.cljs$core$IFn$_invoke$arity$1 ? precompiled25889.cljs$core$IFn$_invoke$arity$1(G__25890) : precompiled25889.call(null,G__25890));
} else {
return precompiled25889;
}
})(),test.core.get_path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"geo1","geo1",326158261),geo], 0)))))?com.rpl.specter.impl.compiled_setval_STAR_((function (){var info__19843__auto__ = test.core.pathcache25891;
var info__19843__auto____$1 = (((info__19843__auto__ == null))?(function (){var info25892 = com.rpl.specter.impl.magic_precompilation(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [com.rpl.specter.impl.__GT_VarUse(com.rpl.specter.MAP_VALS,new cljs.core.Var(function(){return com.rpl.specter.MAP_VALS;},new cljs.core.Symbol("com.rpl.specter","MAP-VALS","com.rpl.specter/MAP-VALS",1866158706,null),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"ns","ns",441598760),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"file","file",-1269645878),new cljs.core.Keyword(null,"end-column","end-column",1425389514),new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"end-line","end-line",1837326455),new cljs.core.Keyword(null,"arglists","arglists",1661989754),new cljs.core.Keyword(null,"doc","doc",1913296891),new cljs.core.Keyword(null,"test","test",577538877)],[new cljs.core.Symbol(null,"com.rpl.specter","com.rpl.specter",-2029095616,null),new cljs.core.Symbol(null,"MAP-VALS","MAP-VALS",-471141163,null),"com/rpl/specter.cljc",(11),(1),(698),(701),cljs.core.List.EMPTY,"Navigate to each value of the map. This is more efficient than\n          navigating via [ALL LAST]",(cljs.core.truth_(com.rpl.specter.MAP_VALS)?com.rpl.specter.MAP_VALS.cljs$lang$test:null)])),new cljs.core.Symbol("sp","MAP-VALS","sp/MAP-VALS",-471139658,null))], null),"test.core",cljs.core.PersistentVector.EMPTY,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol("sp","MAP-VALS","sp/MAP-VALS",-471139658,null)], null));
test.core.pathcache25891 = info25892;

return info25892;
})():info__19843__auto__);
var precompiled25893 = com.rpl.specter.impl.cached_path_info_precompiled(info__19843__auto____$1);
var dynamic_QMARK___19844__auto__ = com.rpl.specter.impl.cached_path_info_dynamic_QMARK_(info__19843__auto____$1);
if(cljs.core.truth_(dynamic_QMARK___19844__auto__)){
var G__25894 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [com.rpl.specter.MAP_VALS], null);
return (precompiled25893.cljs$core$IFn$_invoke$arity$1 ? precompiled25893.cljs$core$IFn$_invoke$arity$1(G__25894) : precompiled25893.call(null,G__25894));
} else {
return precompiled25893;
}
...
return (function (val){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [null], null),com.rpl.specter.impl.compiled_select_STAR_((function (){var info__19843__auto__ = test.core.pathcache25895;
var info__19843__auto____$1 = (((info__19843__auto__ == null))?(function (){var info25896 = com.rpl.specter.impl.magic_precompilation(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [com.rpl.specter.impl.__GT_VarUse(com.rpl.specter.MAP_VALS,new cljs.core.Var(function(){return com.rpl.specter.MAP_VALS;},new cljs.core.Symbol("com.rpl.specter","MAP-VALS","com.rpl.specter/MAP-VALS",1866158706,null),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"ns","ns",441598760),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"file","file",-1269645878),new cljs.core.Keyword(null,"end-column","end-column",1425389514),new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"end-line","end-line",1837326455),new cljs.core.Keyword(null,"arglists","arglists",1661989754),new cljs.core.Keyword(null,"doc","doc",1913296891),new cljs.core.Keyword(null,"test","test",577538877)],[new cljs.core.Symbol(null,"com.rpl.specter","com.rpl.specter",-2029095616,null),new cljs.core.Symbol(null,"MAP-VALS","MAP-VALS",-471141163,null),"com/rpl/specter.cljc",(11),(1),(698),(701),cljs.core.List.EMPTY,"Navigate to each value of the map. This is more efficient than\n          navigating via [ALL LAST]",(cljs.core.truth_(com.rpl.specter.MAP_VALS)?com.rpl.specter.MAP_VALS.cljs$lang$test:null)])),new cljs.core.Symbol("sp","MAP-VALS","sp/MAP-VALS",-471139658,null))], null),"test.core",cljs.core.PersistentVector.EMPTY,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol("sp","MAP-VALS","sp/MAP-VALS",-471139658,null)], null));
test.core.pathcache25895 = info25896;

return info25896;
})():info__19843__auto__);
var precompiled25897 = com.rpl.specter.impl.cached_path_info_precompiled(info__19843__auto____$1);
var dynamic_QMARK___19844__auto__ = com.rpl.specter.impl.cached_path_info_dynamic_QMARK_(info__19843__auto____$1);
if(cljs.core.truth_(dynamic_QMARK___19844__auto__)){
var G__25898 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [com.rpl.specter.MAP_VALS], null);
return (precompiled25897.cljs$core$IFn$_invoke$arity$1 ? precompiled25897.cljs$core$IFn$_invoke$arity$1(G__25898) : precompiled25897.call(null,G__25898));
} else {
return precompiled25897;
}
})(),val))){
return null;
} else {
