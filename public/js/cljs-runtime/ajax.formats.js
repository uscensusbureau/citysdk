...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__22927){
...
var request = map__22928__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22928__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__22932 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__22932.cljs$core$IFn$_invoke$arity$1 ? fexpr__22932.cljs$core$IFn$_invoke$arity$1(response) : fexpr__22932.call(null,response));
});

ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__22933 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__22933.cljs$core$IFn$_invoke$arity$1 ? fexpr__22933.cljs$core$IFn$_invoke$arity$1(response) : fexpr__22933.call(null,response));
});
});

ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2;

ajax.formats.accept_header = (function ajax$formats$accept_header(p__22934){
...
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22935__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
