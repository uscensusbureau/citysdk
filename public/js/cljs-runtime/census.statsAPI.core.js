...
census.statsAPI.core.kv_pair__GT_str = (function census$statsAPI$core$kv_pair__GT_str(p__31614,separator){
 ...
 */
census.statsAPI.core.C_S_args__GT_url = (function census$statsAPI$core$C_S_args__GT_url(p__31627){
...
var vintage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31628__$1,new cljs.core.Keyword(null,"vintage","vintage",818195578));
var sourcePath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31628__$1,new cljs.core.Keyword(null,"sourcePath","sourcePath",-986600405));
var geoHierarchy = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31628__$1,new cljs.core.Keyword(null,"geoHierarchy","geoHierarchy",380422740));
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31628__$1,new cljs.core.Keyword(null,"values","values",372645556));
var predicates = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31628__$1,new cljs.core.Keyword(null,"predicates","predicates",620402712));
var statsKey = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31628__$1,new cljs.core.Keyword(null,"statsKey","statsKey",452548050));
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(census.utils.core.URL_STATS),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.str.cljs$core$IFn$_invoke$arity$1(vintage)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cuerdas.core.join.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (map__31628,map__31628__$1,vintage,sourcePath,geoHierarchy,values,predicates,statsKey){
return (function (p1__31624_SHARP_){
return ["/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__31624_SHARP_)].join('');
});})(map__31628,map__31628__$1,vintage,sourcePath,geoHierarchy,values,predicates,statsKey))
,sourcePath))),"?get=",cljs.core.str.cljs$core$IFn$_invoke$arity$1((((!((values == null))))?cuerdas.core.join.cljs$core$IFn$_invoke$arity$2(",",values):"")),cljs.core.str.cljs$core$IFn$_invoke$arity$1((((!((predicates == null))))?["&",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cuerdas.core.join.cljs$core$IFn$_invoke$arity$2("&",cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (map__31628,map__31628__$1,vintage,sourcePath,geoHierarchy,values,predicates,statsKey){
return (function (p1__31625_SHARP_){
return census.statsAPI.core.kv_pair__GT_str(p1__31625_SHARP_,"=");
});})(map__31628,map__31628__$1,vintage,sourcePath,geoHierarchy,values,predicates,statsKey))
,predicates))))].join(''):"")),cljs.core.str.cljs$core$IFn$_invoke$arity$1(census.utils.core.keys__GT_strs(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(geoHierarchy)))?["&for=",cljs.core.str.cljs$core$IFn$_invoke$arity$1(census.statsAPI.core.kv_pair__GT_str(cljs.core.first(geoHierarchy),":"))].join(''):["&in=",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cuerdas.core.join.cljs$core$IFn$_invoke$arity$2("%20",cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (map__31628,map__31628__$1,vintage,sourcePath,geoHierarchy,values,predicates,statsKey){
return (function (p1__31626_SHARP_){
return census.statsAPI.core.kv_pair__GT_str(p1__31626_SHARP_,":");
});})(map__31628,map__31628__$1,vintage,sourcePath,geoHierarchy,values,predicates,statsKey))
 ...
 *   
 */
census.statsAPI.core.xf_BANG__CSV__GT_CLJ = (function census$statsAPI$core$xf_BANG__CSV__GT_CLJ(p__31646){
var map__31651 = p__31646;
...
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31651__$1,new cljs.core.Keyword(null,"values","values",372645556));
var predicates = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31651__$1,new cljs.core.Keyword(null,"predicates","predicates",620402712));
...
return census.utils.core.xf_BANG__LT__LT_(((function (parse_range,map__31651,map__31651__$1,values,predicates){
...
var G__31676 = acc;
var G__31677 = cljs.core.zipmap(cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.keyword,cljs.core.deref(state)),census.utils.core.map_idcs_range(census.statsAPI.core.__GT_num_QMARK___GT__SHARP_,parse_range,this$));
...
});})(parse_range,map__31651,map__31651__$1,values,predicates))
);
});
census.statsAPI.core.xf_stats__GT_js = (function census$statsAPI$core$xf_stats__GT_js(args){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2(census.statsAPI.core.xf_BANG__CSV__GT_CLJ(args),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__31678_SHARP_){
return cljs.core.clj__GT_js.cljs$core$IFn$_invoke$arity$variadic(p1__31678_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true], 0));
})));
});
...
var G__31699_31833 = cljs.core.async.to_chan(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [url], null));
var G__31700_31834 = _EQ_JSON_EQ_;
var G__31701_31835 = _EQ_E_EQ_;
(census.statsAPI.core.$GET$_C_stats.cljs$core$IFn$_invoke$arity$3 ? census.statsAPI.core.$GET$_C_stats.cljs$core$IFn$_invoke$arity$3(G__31699_31833,G__31700_31834,G__31701_31835) : census.statsAPI.core.$GET$_C_stats.call(null,G__31699_31833,G__31700_31834,G__31701_31835));
...
var G__31740 = acc;
var G__31741 = cljs.core.PersistentArrayMap.createAsIfByAssoc([cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.vals(cljs.core.take_last((cljs.core.count(this$) - vars_SHARP_),this$))),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"properties","properties",685819552),this$], null)]);
