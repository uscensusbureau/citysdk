...
var G__24346 = cljs.core.first(element_str);
switch (G__24346) {
case "?":
arr.push((1));
...
var G__24368 = cljs.core.next(items);
items = G__24368;
continue;
} else {
return null;
...
var G__24371 = cljs.core.next(items);
items = G__24371;
continue;
} else {
return null;
...
while(true){
if(items){
if(cljs.core.truth_((function (){var G__24361 = cljs.core.first(items);
return (is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1 ? is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1(G__24361) : is_valid_QMARK_.call(null,G__24361));
})())){
var G__24378 = cljs.core.next(cljs.core.next(items));
items = G__24378;
continue;
} else {
return true;
...
switch (G__24364) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,((function (G__24364){
return (function (p1__24362_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__24362_SHARP_,(2));
});})(G__24364))
))){
...
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__24363_SHARP_,(1));
});})(G__24364))
))){
