...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__8767){
var map__8768 = p__8767;
var map__8768__$1 = (((((!((map__8768 == null))))?(((((map__8768.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__8768.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__8768):map__8768);
var request = map__8768__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8768__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__8772 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__8772.cljs$core$IFn$_invoke$arity$1 ? fexpr__8772.cljs$core$IFn$_invoke$arity$1(response) : fexpr__8772.call(null,response));
});

ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__8773 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__8773.cljs$core$IFn$_invoke$arity$1 ? fexpr__8773.cljs$core$IFn$_invoke$arity$1(response) : fexpr__8773.call(null,response));
});
});

ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2;

ajax.formats.accept_header = (function ajax$formats$accept_header(p__8774){
...
var request = map__8775__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8775__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
