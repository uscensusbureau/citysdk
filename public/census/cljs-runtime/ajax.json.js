...
var ajax$json$make_json_response_format_$_json_response_format__1 = (function (p__8718){
var map__8719 = p__8718;
var map__8719__$1 = (((((!((map__8719 == null))))?(((((map__8719.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__8719.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__8719):map__8719);
var prefix = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8719__$1,new cljs.core.Keyword(null,"prefix","prefix",-265908465));
var keywords_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8719__$1,new cljs.core.Keyword(null,"keywords?","keywords?",764949733));
var raw = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8719__$1,new cljs.core.Keyword(null,"raw","raw",1604651272));
return ajax.interceptors.map__GT_ResponseFormat(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"read","read",1140058661),((function (map__8719,map__8719__$1,prefix,keywords_QMARK_,raw){
return (function ajax$json$make_json_response_format_$_json_response_format_$_json_read_response_format(xhrio){
var G__8721 = raw;
var G__8722 = keywords_QMARK_;
var G__8723 = ajax.json.strip_prefix(prefix,ajax.protocols._body(xhrio));
return (read_json.cljs$core$IFn$_invoke$arity$3 ? read_json.cljs$core$IFn$_invoke$arity$3(G__8721,G__8722,G__8723) : read_json.call(null,G__8721,G__8722,G__8723));
});})(map__8719,map__8719__$1,prefix,keywords_QMARK_,raw))
...
ajax$json$make_json_response_format_$_json_response_format = function(p__8718){
switch(arguments.length){
case 0:
return ajax$json$make_json_response_format_$_json_response_format__0.call(this);
case 1:
return ajax$json$make_json_response_format_$_json_response_format__1.call(this,p__8718);
}
