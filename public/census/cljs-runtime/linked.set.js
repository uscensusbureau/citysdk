...
return cljs.core.contains_QMARK_(coll__$1,p1__12133_SHARP_);
});})(coll__$1))
,other)));
});
...
linked.set.LinkedSet.prototype.apply = (function (self__,args12134){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args12134)));
});
