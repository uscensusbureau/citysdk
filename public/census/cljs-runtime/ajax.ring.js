...
ajax.ring.ring_response_format.cljs$core$IFn$_invoke$arity$1 = (function (p__8919){
var map__8920 = p__8919;
var map__8920__$1 = (((((!((map__8920 == null))))?(((((map__8920.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__8920.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__8920):map__8920);
var map__8921 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8920__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var map__8921__$1 = (((((!((map__8921 == null))))?(((((map__8921.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__8921.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__8921):map__8921);
var read = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8921__$1,new cljs.core.Keyword(null,"read","read",1140058661));
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8921__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
var content_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8921__$1,new cljs.core.Keyword(null,"content-type","content-type",-508222634));
