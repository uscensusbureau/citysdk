...
ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4303__auto__,k8205,else__4304__auto__){
var self__ = this;
var this__4303__auto____$1 = this;
var G__8209 = k8205;
var G__8209__$1 = (((G__8209 instanceof cljs.core.Keyword))?G__8209.fqn:null);
switch (G__8209__$1) {
case "status":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k8205,else__4304__auto__);
...
return (function (ret__4323__auto__,p__8210){
var vec__8211 = p__8210;
var k__4324__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8211,(0),null);
var v__4325__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8211,(1),null);
...
ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__8204){
var self__ = this;
var G__8204__$1 = this;
return (new cljs.core.RecordIter((0),G__8204__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
var h__4159__auto____$1 = (function (){var fexpr__8221 = ((function (h__4159__auto__,this__4297__auto____$1){
return (function (coll__4298__auto__){
return (-473222333 ^ cljs.core.hash_unordered_coll(coll__4298__auto__));
});})(h__4159__auto__,this__4297__auto____$1))
;
return fexpr__8221(this__4297__auto____$1);
})();
...
ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this8206,other8207){
var self__ = this;
var this8206__$1 = this;
return (((!((other8207 == null)))) && ((this8206__$1.constructor === other8207.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this8206__$1.status,other8207.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this8206__$1.body,other8207.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this8206__$1.status_text,other8207.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this8206__$1.headers,other8207.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this8206__$1.was_aborted,other8207.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this8206__$1.__extmap,other8207.__extmap)));
});
...
ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4308__auto__,k__4309__auto__,G__8204){
var self__ = this;
var this__4308__auto____$1 = this;
var pred__8227 = cljs.core.keyword_identical_QMARK_;
var expr__8228 = k__4309__auto__;
if(cljs.core.truth_((function (){var G__8230 = new cljs.core.Keyword(null,"status","status",-1997798413);
var G__8231 = expr__8228;
return (pred__8227.cljs$core$IFn$_invoke$arity$2 ? pred__8227.cljs$core$IFn$_invoke$arity$2(G__8230,G__8231) : pred__8227.call(null,G__8230,G__8231));
})())){
return (new ajax.protocols.Response(G__8204,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__8232 = new cljs.core.Keyword(null,"body","body",-2049205669);
var G__8233 = expr__8228;
return (pred__8227.cljs$core$IFn$_invoke$arity$2 ? pred__8227.cljs$core$IFn$_invoke$arity$2(G__8232,G__8233) : pred__8227.call(null,G__8232,G__8233));
})())){
return (new ajax.protocols.Response(self__.status,G__8204,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__8234 = new cljs.core.Keyword(null,"status-text","status-text",-1834235478);
var G__8235 = expr__8228;
return (pred__8227.cljs$core$IFn$_invoke$arity$2 ? pred__8227.cljs$core$IFn$_invoke$arity$2(G__8234,G__8235) : pred__8227.call(null,G__8234,G__8235));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,G__8204,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__8236 = new cljs.core.Keyword(null,"headers","headers",-835030129);
var G__8237 = expr__8228;
return (pred__8227.cljs$core$IFn$_invoke$arity$2 ? pred__8227.cljs$core$IFn$_invoke$arity$2(G__8236,G__8237) : pred__8227.call(null,G__8236,G__8237));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__8204,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__8238 = new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828);
var G__8239 = expr__8228;
return (pred__8227.cljs$core$IFn$_invoke$arity$2 ? pred__8227.cljs$core$IFn$_invoke$arity$2(G__8238,G__8239) : pred__8227.call(null,G__8238,G__8239));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__8204,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4309__auto__,G__8204),null));
}
}
}
}
...
ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4300__auto__,G__8204){
var self__ = this;
var this__4300__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__8204,self__.__extmap,self__.__hash));
});
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__8208){
var extmap__4340__auto__ = (function (){var G__8246 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__8208,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__8208)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__8246);
} else {
return G__8246;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__8208),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__8208),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__8208),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__8208),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__8208),null,cljs.core.not_empty(extmap__4340__auto__),null));
});
