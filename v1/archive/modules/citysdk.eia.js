...
EIAModule.prototype.DEFAULT_ENDPOINTS.apiURL =  "//services.eia.gov/";
...
EIAModule.prototype.categoryRequest = function(request, callback) {
    ...
    CitySdk.get(categoryURL).done(function(response) {
...
EIAModule.prototype.seriesRequest = function(request, callback) {
    ...
    CitySdk.get(seriesURL).done(function(response) {
        response = jQuery.parseJSON(response);
        callback(response);
    });
};
