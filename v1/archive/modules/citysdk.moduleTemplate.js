...
ModuleTemplateModule.prototype.APIRequest = function(request, callback) {
    ...
    CitySdk.prototype.sdkInstance.getCachedData("moduleTemplate", "APIRequest", cacheKey, function (cachedData) {
        if (cachedData != null) {
            ...
            an services that may return different results from the same request (such as a request that
            retrieves the current weather report), add logic as needed that test the data for
