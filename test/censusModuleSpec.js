...
describe('CensusModule', function() {
  ...
  describe('Async call to external services for retreiveing acs5 2013 variables', function() {
    var result;
    ...
    it('should return a list of variables for the ACS5 2013 services', function() {
